...
<body>
    ...
    @if($errors->any())
        <div class="container">
            <div class="row">
                <div class="alert-danger text_center mt-3">
                    Por favor selecione pelo menos uma operação. As parcelas devem números entre 0 e 999. O número de exercícios deve ser de 5 a 50.
                </div>
            </div>
        </div>
    @endif
